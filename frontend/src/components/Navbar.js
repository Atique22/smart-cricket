  ...
  return (
    ...
    <nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <a href="https://flowbite.com/" className="flex items-center">
          {/* <img src="" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo">  LOGO*/} 
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Smart Batting </span>
      </a>
      ...
      <div className="flex md:order-2">
          ...
          <button onClick={HandleOnClick}  data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
      ...
      <div style={{ display: active ? "block" : "none" }} className={` justify-between items-center w-full md:flex md:w-auto md:order-1`}  id="navbar-sticky">
